...
public class DummyBoxStackerStrategyTest {
    ...
    @Autowired
    private DummyBoxStackerStrategy boxStackerService;
    ...
    public void testStackBoxes_withEmptyAndNonEmptyTrucks() {
        ...
        nonEmptyTruck.addBoxByCoordinates(0,0,box1); // Simulate a box in the truck
    ...
    public void testStackBoxes_withMoreBoxesThanTrucksIncludingNonEmpty() {
        ...
        List<Box> boxList = new ArrayList<>();
        boxList.add(box2);
        boxList.add(box2); // Add more boxes than available trucks
    ...
    public void testStackBoxes_withEmptyBoxListAndNonEmptyTrucks() {
        ...
        Truck nonEmptyTruck = new Truck();
        Box box1 = BoxType.ONE.getBox();
        nonEmptyTruck.addBoxByCoordinates(0,0,box1);
    ...
    public void testStackBoxes_withThreeNonEmptyTrucksAndOneEmptyTruck() {
        ...
        Box box1 = BoxType.ONE.getBox();
        Box box2 = BoxType.ONE.getBox();
        Box box3 = BoxType.ONE.getBox();
        // Simulate boxes in non-empty trucks
        nonEmptyTruck1.addBoxByCoordinates(0,0,box1);
        nonEmptyTruck2.addBoxByCoordinates(0,0,box2);
        nonEmptyTruck3.addBoxByCoordinates(0,0,box3);
        ...
        Box box4 = BoxType.ONE.getBox();
        Box box5 = BoxType.ONE.getBox();
        List<Box> boxList = new ArrayList<>();
        boxList.add(box4);
        boxList.add(box5); // Add two boxes
